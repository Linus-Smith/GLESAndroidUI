...
import com.linus.glesandroiduilib.GLES.Utils.Utils;
import com.linus.glesandroiduilib.GLES.anim.Animation;
...
public class SlotView extends GLView {
    ...
    public SlotView(Context activity, Spec spec, GLRoot rootView) {
        mGestureDetector = new GestureDetector(activity, new MyGestureListener());
        mScroller = new ScrollerHelper(activity);
        mHandler = new SynchronizedHandler(rootView);
        setSlotSpec(spec);
    }
